...
| **P&L Waterfall** | Visual breakdown of revenue → COGS → OpEx → net income for latest month |
...
- Gross margin begins at 74% but faces COGS creep
- Marketing spend surge baked in at month 14
- Headcount hiring sprints at months 6, 12, and 18
...
- Cash burn accelerates as revenue growth slows
...
2. **Financial Trends** — Interactive Plotly charts across three tabs:
   - Revenue & Profitability (revenue, gross profit, MoM growth)
...
5. **Cash Flow & Burn Analysis** — P&L waterfall for latest month + cash balance trend
...
- **Data Engineering**: Synthetic data generation with controlled noise and embedded signals using NumPy
...
- **NLP / Insight Generation**: Rule-based narrative generation from analytical outputs
...
This project is designed to demonstrate the type of analytical tooling a **technology consultant** might deliver to a CFO, finance team, or investor audience. It showcases:
